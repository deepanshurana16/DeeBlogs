  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.about}>
        ...
        <p className={`${styles.para} ${styles.social}`}>Social links: <Link href="https://www.linkedin.com/in/harshsingh0310/" className={styles.link} > <LinkedinImage></LinkedinImage> Linkedin</Link> <Link href="https://github.com/lives-in-virgosupercluster" className={styles.link}><GithubImage></GithubImage>
  Github</Link></p>
        </div>
